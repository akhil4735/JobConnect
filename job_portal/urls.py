...
urlpatterns = [
    ...
    path('my-posted-jobs/', my_posted_jobs, name='my_posted_jobs'),  # My Posted Jobs
    path('update-application-status/<int:application_id>/', update_application_status, name='update_application_status'),  # Update Application Status
